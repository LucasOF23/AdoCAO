        ...
        <form className="Auth-form">
          <div className="Auth-form-content">
            ...
            <div className="form-group mt-8 ml-5">
              <label className="user text-lg font-bold text-white mt-10">
                Usuário:
              </label>
              <input
                type="user"
            ...
            <div className="form-group mt-5 ml-5">
              <label className="password text-lg font-bold text-white">
                Senha:
              </label>
              <input
                type="password"
    ...
    <div className="w-full h-full bg-[#C480D9] rounded-md content-center">
      <form className="Auth-form">
        <div className="Auth-form-content">
          ...
          <div className="form-group mt-8 ml-5">
            <label className="text-lg font-bold text-white mt-10">
              Nome Completo:
            </label>
            <input
              type="name"
