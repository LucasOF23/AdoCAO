...
export default function EditPerfil() {
  ...
  const [type_locText, setTypelocText] = useState(
    profileInfo.location.type_loc
  );
      ...
      <div className="pl-[5vw] pt-[2vw] screen-max-width flex md:flex-row flex-col">
        ...
        <div className="w-full">
          <div>
            ...
            <CopyText
              text={`ID pessoal: ${profileInfo.id.toString()}`}
              copy={profileInfo.id.toString()}
            />
          </div>
