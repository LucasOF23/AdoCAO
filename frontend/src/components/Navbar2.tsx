  ...
  if (isUserLoggedIn) {
    trailing = (
      <details className="absolute right-10 top-4 dropdown content-center">
        <summary className="bg-purple-300 hover:bg-purple-400 duration-75 hover:scale-[105%] px-5 py-3 rounded-xl my-auto">
          Menu
        </summary>
        <ul className="p-1 shadow menu z-[1] bg-white rounded-box">
          ...
          <hr />
          <li className="hover:bg-gray-500">
            <a href="/home" className="w-full p-2 block text-center">
              Home
            </a>
          </li>
          <hr />
