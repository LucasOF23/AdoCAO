...
export default function Lowerbar() {
  return (
    <>
      <div className="border-b-2 bg-purple-200">
        <div className="my-20 mx-auto min-mx-5 screen-max-width grid justify-items-center grid-autofit items-center">
          <div>
            ...
            <div className="text-justify mx-5 mb-10">
              ...
              de ONG&lsquo;s e outros usuários. Um dos principais objetivos dessa inciativa é diminuir o fluxo de novos 
              animais para dentro das ONG&lsquo;s responsáveis por realizar esse acolhimento, assim evitando uma possível 
              superlotação delas. Além disso, é imperativo que seja garantido a melhor qualidade de vida para esses 
              animais, seja em posse de ONG&lsquo;s com espaço para providencia-la ou em posse de novos donos, sendo o 
